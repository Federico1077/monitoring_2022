...
# Exsercise import the data from March NO2 and plot it
en13 <- raster("EN_0013.png")
plot(en13, col=cl)

# Build a multiframe window with 2 rows and 1 coloumn
par(mfrow=c(2,1))
plot(en01, col=cl)
plot(en13, col=cl)
...
# day 2
# importing all the data togheter with the laaply function
